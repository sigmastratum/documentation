...
- **SL1 — Dialog State:** short-term recurrence and symbol reactivation.  
...
1. **Field Layer (Cognitive Field Engine)**  
   ...
   - Attractor State (symbol set, constraints, and stability metrics)  
...
- Persistent identity across recursive cycles  
- Integration of intent and memory within attractor envelopes  
...
- Preservation of semantic and structural integrity  
- Controlled symbolic density and recursion depth  
- Formal shutdown and recovery through the **Fail-Safe Envelope**
...
- **SL0:** human intent and interpretation  
