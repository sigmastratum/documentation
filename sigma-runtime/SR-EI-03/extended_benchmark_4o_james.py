"""
SIGMA v0.3 vs Baseline - James Identity Benchmark
================================================
Objective comparison: token consumption & latency
...
Usage:
    python3 benchmark_james.py [num_cycles] [scenario_file]
    
Examples:
    python3 benchmark_james.py 30
    python3 benchmark_james.py 110
    python3 benchmark_james.py 200
    python3 benchmark_james.py 110 custom_scenario.md
"""
...
from sigma_runtime_v0_3_4o_james import SigmaRuntime
...
class BaselineAgent:
    """Baseline: standard message history, no instrumentation"""
    ...
    def __init__(self, identity_file: str):
        ...
        # Load identity from file and use as system message (message[0])
        ...
        print(f"✓ Baseline initialized with system prompt from {identity_file}")
    ...
    def _estimate_tokens(self) -> int:
        return estimate_tokens(self.messages, model=self.model_name)
...
def run_comparison(num_cycles: int, identity_file: str, scenario_file: str = "test_scenario_200.md"):
    ...
    print("\n" + "="*70)
    print(f"SIGMA v0.3 vs BASELINE - {num_cycles} CYCLES (James)")
    print("="*70)
    print()
...
def generate_markdown_report(data: Dict, filepath: str, timestamp: str):
    ...
    lines = [
        f"# SIGMA v0.3 vs Baseline - James Identity",
        f"",
        f"**Date:** {timestamp}",
