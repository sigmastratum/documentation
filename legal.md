...
> This section defines the legal framework, licensing model, and attribution  
> requirements governing the **Sigma Runtime Standard (SRS)** and associated  
> documentation under the **Sigma Stratum Project**.
...
- **Attribution** — credit must be given to the original author(s) and the Sigma Stratum Project.  
...
Use of excerpts, figures, or derivative works must preserve the license header and  
...
External contributions (via pull requests or SRIPs) are governed by the  
terms of `/legal/attribution.md` and `/legal/IP-Policy.md`.
